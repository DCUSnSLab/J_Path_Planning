...
class AstarAndExpenderDisparity:
    CAR_WIDTH = 0.29  # simulator car
    ...
    def fusionAlgorithm(self, waypoint_list, current_position):
        waypoint_range = ObstaclePositionEstimation().waypoint_range(waypoint_list, current_position,
